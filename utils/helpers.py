...
def make_api_request(method: str, endpoint: str, params: dict = None, headers: dict = None):
    """
...
def build_search_params(phrase: str, city_id: str = "213", ab_group: str = "1") -> dict:
    """
...
def save_response_to_file(response_json: dict, filename: str = "last_response.json"):
    """
...
if __name__ == "__main__":
    ...
    if response.status_code == 200:
        ...
        print("JSON структура валидна?", validate_json_structure(data, ["data"]))
    else:
